...
onAnimationStart :: forall eff props state result.
  (SyntheticAnimationEvent eff () -> SyntheticEventHandlerContext eff props state result) -> Props
...
onTransitionEnd :: forall eff props state result.
  (SyntheticTransitionEvent eff () -> SyntheticEventHandlerContext eff props state result) -> Props
onTransitionEnd f = unsafeMkProps "onTransitionEnd" (handle f)

onToggle :: forall eff props state result.
  (SyntheticEvent eff () -> SyntheticEventHandlerContext eff props state result) -> Props
...
onCopy :: forall eff props state result.
  (SyntheticClipboardEvent eff () -> SyntheticEventHandlerContext eff props state result) -> Props
...
onCompositionEnd :: forall eff props state result.
  (SyntheticCompositionEvent eff () -> SyntheticEventHandlerContext eff props state result) -> Props
...
onKeyDown :: forall eff props state result.
  (SyntheticKeyboardEvent eff () -> SyntheticEventHandlerContext eff props state result) -> Props
...
onFocus :: forall eff props state result.
  (SyntheticFocusEvent eff () -> SyntheticEventHandlerContext eff props state result) -> Props
...
onChange :: forall eff props state result.
  (SyntheticInputEvent eff () -> SyntheticEventHandlerContext eff props state result) -> Props
...
onClick :: forall eff props state result.
  (SyntheticMouseEvent eff () -> SyntheticEventHandlerContext eff props state result) -> Props
...
onTouchCancel :: forall eff props state result.
  (SyntheticTouchEvent eff () -> SyntheticEventHandlerContext eff props state result) -> Props
...
onScroll :: forall eff props state result.
  (SyntheticUIEvent eff () -> SyntheticEventHandlerContext eff props state result) -> Props
onScroll f = unsafeMkProps "onScroll" (handle f)

onWheel :: forall eff props state result.
  (SyntheticWheelEvent eff () -> SyntheticEventHandlerContext eff props state result) -> Props
